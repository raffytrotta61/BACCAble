...
#pragma message ("FW_VERSION: " _FW_VERSION)
	...
	uint8_t dashboard_main_menu_array[20][DASHBOARD_MESSAGE_MAX_LENGTH]={
			...
			{'F','R','E','N','I',' ','A','N','T','.',' ','N','o','r','m','a','l',' '},
			{'4','W','D',' ',' ','A','T','T','I','V','A',' ',' ',' ',' ',' ',' ',' '},
			{'I','M','P','.',' ','M','E','N','U',' ','P','R','I','N','C','I','P','.'},
			{'I','M','P','.',' ','M','E','N','U',' ','P','A','R','A','M','.',' ',' '},
			{'A','T','T','I','V','A',' ','H','A','S',' ',' ',' ',' ',' ',' ',' ',' '},
			{'A','T','T','I','V','A',' ','V','A','L','V','O','L','E',' ','Q','V',' '},
	...
	uint8_t dashboard_setup_menu_array[30][DASHBOARD_MESSAGE_MAX_LENGTH]={
			...
			{'O',' ',' ','I','N','D','.',' ','C','A','M','B','I','A','T','A',' ',' '},
			{'R','P','M',' ','C','A','M','B','I','A','T','A',' ',' ','3','0','0','0'},
			{'O',' ',' ','M','Y','2','3',' ','I','P','C',' ',' ',' ',' ',' ',' ',' '},
			{'O',' ',' ','A','V','V','I','S','O',' ','R','I','G','E','N','.',' ',' '},
